...
static int social_channel_valid(const char *s){return s&&(!strcmp(s,"meta")||!strcmp(s,"instagram")||!strcmp(s,"linkedin")||!strcmp(s,"tiktok")||!strcmp(s,"x")||!strcmp(s,"google")||!strcmp(s,"email")||!strcmp(s,"webhook")||!strcmp(s,"pinterest")||!strcmp(s,"whatsapp")||!strcmp(s,"youtube")||!strcmp(s,"other"));}
