...
def main():
    ...
    check('src/internal.c' in cmake and 'src/telemetry.c' in cmake and 'src/payment_recovery.c' in cmake and 'src/search_science.c' in cmake and 'src/experiment_science.c' in cmake,'commerce telemetry/recovery/search/experiment science are compiled as separate core modules')
