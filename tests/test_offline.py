...
def main():
    ...
    check('src/internal.c' in cmake and 'src/telemetry.c' in cmake and 'src/payment_recovery.c' in cmake and 'src/search_science.c' in cmake and 'src/experiment_science.c' in cmake and 'src/abandonment.c' in cmake,'commerce telemetry/recovery/search/experiment/abandonment are compiled as separate core modules')
